...
- **apropos** - O comando apropos pesquisa nomes e descrições de páginas de manual em busca de uma palavra-chave fornecida pelo usuário.
- **printenv** - O comando printenv exibe os valores das variáveis ​​de ambiente.
- 
- 
- 
- 
